<template>
    <div class="main-app__header">
      <div class="main-app__header_title">
        <div class="main-app__header_title-label">
          Список новостей
        </div>
        <div class="main-app__header_title-refresh">
          <q-btn @click="refresh" flat dense size="md" class="main-app__header_title-button" text-color="primary">
      ...
      <div class="main-app__header_filter">
        <slot name="filter"/>
      </div>
    </div>
</template>
